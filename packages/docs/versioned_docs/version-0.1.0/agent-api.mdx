...
ZK proofs are always generated and submitted on-chain automatically in step 4. See the [ZK Agent Integration](./zk-agent.mdx) for details on proof format and on-chain contracts.
